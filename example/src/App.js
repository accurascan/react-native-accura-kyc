...
export default class App extends React.Component {
  ...
  onPressStartLiveness = () => {
    ...
    var config = {
      feedbackTextSize: 18,
      feedBackframeMessage: this.language == 'en' ? 'Frame Your Face' : 'ضع إطارًا لوجهك',
      feedBackAwayMessage: this.language == 'en' ? 'Move Phone Away' : 'انقل الهاتف بعيدًا',
      feedBackOpenEyesMessage: this.language == 'en' ? 'Keep Your Eyes Open' : 'أبق أعينك مفتوحة',
      feedBackCloserMessage: this.language == 'en' ? 'Move Phone Closer' : 'نقل الهاتف أقرب',
      feedBackCenterMessage: this.language == 'en' ? 'Move Phone Center' : 'نقل مركز الهاتف',
      feedBackMultipleFaceMessage: this.language == 'en' ? 'Multiple Face Detected' : 'تم اكتشاف وجوه متعددة',
      feedBackHeadStraightMessage: this.language == 'en' ? 'Keep Your Head Straight' : 'حافظ على استقامة رأسك',
      feedBackBlurFaceMessage: this.language == 'en' ? 'Blur Detected Over Face' : 'تم اكتشاف ضبابية على الوجه',
      feedBackGlareFaceMessage: this.language == 'en' ? 'Glare Detected' : 'تم الكشف عن الوهج',
      ...
      feedBackLowLightMessage: this.language == 'en' ? 'Low light detected' : 'تم الكشف عن إضاءة منخفضة',
      feedbackLowLightTolerence: 39,
      feedBackStartMessage: this.language == 'en' ? 'Put your face inside the oval' : 'ضع وجهك داخل الشكل البيضاوي',
      feedBackLookLeftMessage: this.language == 'en' ? 'Look over your left shoulder' : 'انظر فوق كتفك الأيسر',
      feedBackLookRightMessage: this.language == 'en' ? 'Look over your right shoulder' : 'انظر فوق كتفك الأيمن',
      feedBackOralInfoMessage: this.language == 'en' ? 'Say each digits out loud' : 'قل كل رقم بصوت عالٍ',
              ...
              </View>
              {
                result.hasOwnProperty("face") ?
                  <View style={styles.modelFace}>
                    ...
                    <View style={{ width: '100%', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginVertical: 10, justifyContent: 'space-around' }}>
                      <TouchableOpacity style={{}} onPress={() => {
                        this.setState({ modalVisible: false })
                        this.onPressStartLiveness()
                      }}>
                        <View style={styles.btnView}>
                          <Image style={{ aspectRatio: 1, width: 18 }} source={require('./assets/images/ic_liveness.png')} />
                          <Text style={{ color: 'white', fontSize: 15, marginLeft: 5 }}>LIVENESS</Text>
                        </View>
                      </TouchableOpacity>
                      <TouchableOpacity style={{}} onPress={() => {
                        this.setState({ modalVisible: false })
                        ...
                        <View style={styles.btnView}>
                          <Image style={{ aspectRatio: 1, width: 18 }} source={require('./assets/images/ic_biometric.png')} />
                          <Text style={{ color: 'white', fontSize: 15, marginLeft: 5 }}>FACE MATCH</Text>
                        </View>
                      </TouchableOpacity>
                    </View>
                    <View style={{ width: '100%', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginBottom: 10, justifyContent: 'space-around' }}>
                      <Text style={{ fontSize: 15, fontWeight: 'bold' }}>{parseInt(this.state.lv_score).toFixed(2) + '%'}</Text>
                      <Text style={{ fontSize: 15, fontWeight: 'bold' }}>{parseInt(this.state.fm_score).toFixed(2) + '%'}</Text>
                    </View>
                  </View>
                  : <View />
              }
